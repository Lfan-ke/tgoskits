...
#   model_realassets - iterate every shipped model, assert parse + counts/bbox vs golden.
set -u
BIN=/opt/cpu-model-test
export PATH="/usr/bin:/usr/local/bin:$PATH"
# Prebuild stages the real models (suzanne/benchy/bunny) and the derived closed-form assets here.
