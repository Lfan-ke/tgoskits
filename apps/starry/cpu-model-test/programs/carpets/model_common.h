 ...
 * well-specified - a clean parser is not "reinventing a heavy lib". Only glTF/glb, a JSON+binary container,
 * goes through the pinned single-header cgltf.h instead of hand-rolled code.
 *
